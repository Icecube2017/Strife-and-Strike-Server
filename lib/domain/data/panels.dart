...
Map<String, SkillType> skillToType = {  
  ...
  SkillId.unwaveringGuard.id: SkillType(cooldown: 2, isExclusive: true),
...
Map<String, List<String>> cardTags = {
  ...
  CardId.blade.id: [TagId.sharp.id],
  ...
  CardId.refractionCrystal.id: [TagId.sharp.id, TagId.disorder.id],
...
Map<String, Map<String, int>> cardDecks = {
  CardDeckId.basic.id: {
    CardId.blade.id: 1,
    CardId.bow.id: 1,
    CardId.mace.id: 1,
    CardId.arrow.id: 1,
    CardId.demonHunterBlade.id: 1,
    CardId.crimsonSwoop.id: 1,
    CardId.echoGlimpse.id: 1,
    CardId.hexastal.id: 1,
  },
  CardDeckId.advanced.id: {
    CardId.apolloArrow.id: 3,
    CardId.octastal.id: 4,
    CardId.babelTower.id: 3,
    CardId.rapier.id: 3,
    CardId.filching.id: 3,
    CardId.damoclesSword.id: 3,
    CardId.blade.id: 4,
    CardId.slownessSpell.id: 3,
    CardId.corruptPendant.id: 3,
    CardId.violentViolet.id: 3,
    CardId.bow.id: 3,
    CardId.highCap.id: 1,
    CardId.highEnergyCan.id: 3,
    CardId.inspire.id: 3,
    CardId.passingGaze.id: 3,
    CardId.cryotheum.id: 3,
    CardId.epilogue.id: 3,
    CardId.amulet.id: 3,
    CardId.regenerating.id: 3,
    CardId.chaoticDrill.id: 3,
    CardId.disruptionField.id: 3,
    CardId.arcticHeart.id: 3,
    CardId.auroraConcussion.id: 3,
    CardId.bless.id: 3,
    CardId.arrow.id: 4,
    CardId.mace.id: 3,
    CardId.demonHunterBlade.id: 3,
    CardId.crimsonSwoop.id: 3,
    CardId.echoGlimpse.id: 3,
    CardId.hexastal.id: 4,
    CardId.strengthSpell.id: 4,
    CardId.strengthSpellIi.id: 2,
    CardId.nanoPermeation.id: 1,
    CardId.pandoraBox.id: 2,
    CardId.shardCrystal.id: 3,
    CardId.hologram.id: 3,
    CardId.gloryRoad.id: 1,
    CardId.meltOrb.id: 3,
    CardId.cloverBlessing.id: 4,
    CardId.decastal.id: 4,
    CardId.refreshment.id: 3,
    CardId.ripplingWater.id: 2,
    CardId.curing.id: 3,
    CardId.floverWish.id: 1,
    CardId.aetherShroud.id: 3,
    CardId.homology.id: 3,
    CardId.criticalStrike.id: 3,
    CardId.sisyphusStone.id: 3,
    CardId.rest.id: 3,
    CardId.swiftSpell.id: 3,
    CardId.pyrotheum.id: 3,
    CardId.edenGarden.id: 3,
    CardId.fragment.id: 3,
    CardId.invisibilitySpell.id: 3,
    CardId.flameSpear.id: 1,
    CardId.frostShield.id: 1,
    CardId.shield.id: 3,
    CardId.declaration.id: 3,
    CardId.refractionCrystal.id: 3,
    CardId.endHalberd.id: 2,
  }
};
